...
export type OnPenaltyPollUpdatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type OnPenaltyPollUpdatedSubscription = { __typename?: 'Subscription', onPenaltyPollUpdated?: { __typename?: 'penaltyPoll', id: string, yesVote: number, noVote: number, isActive: boolean } | null };
...
export const OnPenaltyPollUpdatedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"OnPenaltyPollUpdated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"onPenaltyPollUpdated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"yesVote"}},{"kind":"Field","name":{"kind":"Name","value":"noVote"}},{"kind":"Field","name":{"kind":"Name","value":"isActive"}}]}}]}}]} as unknown as DocumentNode<OnPenaltyPollUpdatedSubscription, OnPenaltyPollUpdatedSubscriptionVariables>;